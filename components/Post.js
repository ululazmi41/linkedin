  ...
  return (
    <div className={`bg-white dark:bg-[#1D2226] ${modalPost ? 'rounded-r-lg' : 'rounded-lg'} space-y-2 py-2.5 border border-gray-300 dark:border-none`}>
      <div className="flex items-center px-2.5 cursor-pointer">
        ...
        <div className="mr-auto ml-2 leading-none">
          ...
          <Timeago
            ...
            className="text-xs dark:tezt-white/75 opacity-89"
          />
        </div>
        {modalPost ? (
      ...
      {post.photoUrl && !modalPost && (
        <img src={post.photoUrl} className="w-full cursor-pointer" onClick={() => {
          setModalOpen(true)
      ...
      <div className="flex justify-evenly items-center dark:border-t border-gray-80 mx-2.5 pt-2 text-black/60">
        {modalPost ? (
